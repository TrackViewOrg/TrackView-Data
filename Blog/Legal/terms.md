...
1. **Lawful Use:** You may use the Service only for lawful purposes and in accordance with these Terms.
...
1. **Service Ownership:** All software, interfaces, analytics systems, and proprietary features are the exclusive property of TRACKVIEW.

2. **User Telemetry:** You retain ownership of raw telemetry data you generate.

3. **Processed and Derived Data:**

   * TRACKVIEW owns all processed, aggregated, anonymized, or derived data, including analytics, benchmarks, and models.
   * You grant TRACKVIEW a perpetual, worldwide, royalty-free license to process and use telemetry data for service operation, improvement, analytics, and research, consistent with the Privacy Policy.
...
2. **As-Is Service:** The Service is provided “as is” and “as available,” without warranties of any kind, except where prohibited by law.

3. **Assumption of Risk:** You assume all risks arising from use of the Service, including performance impacts, data inaccuracies, or compatibility issues.

4. **Excluded Liability:** TRACKVIEW is not responsible for:

   * Data loss, system failures, or corrupted files
   * Competitive penalties, bans, or sanctions imposed by third parties
...
1. TRACKVIEW is not liable for indirect or consequential damages.
...
TRACKVIEW is an early-stage service. We reserve the right to modify, suspend, or permanently discontinue the Service, in whole or in part, at any time.

Where reasonably practicable, we will provide at least **7 days’ notice** prior to permanent discontinuation.
...
1. **Billing Authorization:** By purchasing a subscription, you authorize TRACKVIEW to charge your selected payment method at the stated intervals until cancellation.

2. **Non-Refundable Payments:**

   * All subscription fees are non-refundable.
   * You expressly request immediate access to digital services upon purchase.
   * To the extent permitted by law, you waive any statutory right of withdrawal once service performance has begun.
